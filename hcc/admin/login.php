...
if($_POST['username'] && $_POST['password']){
	...
	if($admin_name==$_JDM['admin_name'] && $admin_pass==$_JDM['admin_pass']){
		$_SESSION['adminSession'] = 'http://www.jiandanma.com';
...
<head>
<title>后台管理登录 - Powered By jiandanma.com</title>
...
<tr class="header">
		...
		<tr>
		  ...
		  <td width="260" align="left" valign="middle"><input name="username" type="text" class="inp" id="username" value="<?php echo !empty($_POST['username']) ? $_POST['username'] : 'admin';?>" autofocus="autofocus" onfocus="select();" size="30" maxlength="32" autocomplete="off"></td>
		</tr>
		<tr>
...
<div class="cl10"></div>
<div id="footer">
  Powered by <a href="http://www.jiandanma.com" target="_blank">JianDanMa.com</a></div><!--footer-->
</BODY>
</HTML>
