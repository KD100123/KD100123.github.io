...
<tr class="thead">
<td colspan="2" align="center">扩展管理</td>
</tr>
<tr style="color:#999;">
    <td colspan="2" valign="top" style="padding-left:20px;">说明：扩展功能可以指定搜索哪些关键词，显示指定的内容，可以在搜索结果上方显示，也可以在右侧显示<p>①、选择“<span style="color:blue">等于</span>”或者“<span style="color:blue">包含</span>”时，支持多个关键词匹配，比如想搜索关键词包含“<span style="color:red">源码</span>”或者“<span style="color:red">建站</span>”都显示简单码源码论坛，可以用“|”分开，比如填写“<span style="color:red">源码|建站</span>”。</p>
    <p>
