...
<tr>
    <td colspan="2" align="left" valign="middle" class="s_title" style="line-height:180%">　　网站地图是2.X版新增的功能，网站地图功能主要是为了方便搜索引擎蜘蛛爬找收录。简单码源码论坛搜索程序跟普通网站不一样，只需要关键词就可创建页面，关键词是无限的，也就是说可以创建无限个页面。我们可以创建一些热门的或者我们需要某个行业的关键词。<br />
